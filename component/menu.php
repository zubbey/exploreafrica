...
<head>
    ...
    <meta name="author" content="ColoreDigit inc">
    <!-- Meta Description -->
    ...
    CSS
    ============================================= -->
    <link href="https://fonts.googleapis.com/css?family=Roboto:100,100i,300,300i,400,400i,500,500i,700,900,900i&display=swap"
          rel="stylesheet">
...
<div class="container section-1">
    <nav class="navbar navbar-expand-lg navtop">
        <a class="navbar-brand" href="www.exploreafricafoundation.org">
    ...
    <nav class="navbar navbar-expand-lg navbottom">
        ...
        <ul class="navbar-nav">
            <li id="nav1" class="nav-item">
                <a class="nav-link" href="www.exploreafricafoundation.org">Latest <span class="sr-only">(current)</span></a>
            </li>
