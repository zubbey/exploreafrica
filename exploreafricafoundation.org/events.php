	...
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Explore Africa Foundation | Events</title>
	  			...
	  			<div class="container">
			  		<div class="row">
			  			...
			  			<div class="col-lg-6 col-sm-6 col-4 header-top-right no-padding">
			  				...
			  				<a href="mailto:support@colorlib.com"><span class="lnr lnr-envelope"></span> <span class="text">join@exploreafricafoundation.com</span></a>			
			  			</div>
			  		</div>			  					
	  			</div>
			</div>
					...
					<div class="row align-items-center">
						<div class="col-lg-6 pb-30">
							<div class="single-carusel row align-items-center">
								...
								<div class="detials col-12 col-md-6">
									<p>14th january, 2016</p>
									<a href="event-details.html"><h4>Youth Konnect for Peace Network</h4></a>
									<p>
						...
						<div class="col-lg-6 pb-30">
							<div class="single-carusel row align-items-center">
								...
								<div class="detials col-12 col-md-6">
									<p>12th March, 2019</p>
									<a href="event-details.html"><h4>Electral Violence and Drug Abuse Campaign</h4></a>
									<p>
										For most of us, the idea of astronomy is something we directly connect to “stargazing”, telescopes and seeing magnificent displays in the heavens.
									</p>
								</div>
						...
						<div class="col-lg-6 pb-30">
							<div class="single-carusel row align-items-center">
								...
								<div class="detials col-12 col-md-6">
									<p>08th April, 2010</p>
									<a href="event-details.html"><h4>Social innovators forum</h4></a>
									<p>
										For most of us, the idea of astronomy is something we directly connect to “stargazing”, telescopes and seeing magnificent displays in the heavens.
									</p>
								</div>
						...
						<div class="col-lg-6 pb-30">
							<div class="single-carusel row align-items-center">
								...
								<div class="detials col-12 col-md-6">
									<p>01th February, 2017</p>
									<a href="event-details.html"><h4>Renovation and upgrade of community schools libraries and laboratories</h4></a>
									<p>
										For most of us, the idea of astronomy is something we directly connect to “stargazing”, telescopes and seeing magnificent displays in the heavens.
									</p>
								</div>
						...
						<div class="col-lg-6 pb-30">
							<div class="single-carusel row align-items-center">
								...
								<div class="detials col-12 col-md-6">
									<p>25th June, 2019</p>
									<a href="event-details.html"><h4>Educational support and scholarship programme</h4></a>
									<p>
										For most of us, the idea of astronomy is something we directly connect to “stargazing”, telescopes and seeing magnificent displays in the heavens.
									</p>
								</div>
						...
						<div class="col-lg-6" pb-30>
							<div class="single-carusel row align-items-center">
								...
								<div class="detials col-12 col-md-6">
									<p>5th February, 2018</p>
									<a href="event-details.html"><h4>Summer ICT and Personal development bootcamp</h4></a>
									<p>
										For most of us, the idea of astronomy is something we directly connect to “stargazing”, telescopes and seeing magnificent displays in the heavens.
									</p>
								</div>
						...
						<div class="col-lg-6 pb-30">
							<div class="single-carusel row align-items-center">
								...
								<div class="detials col-12 col-md-6">
									<p>15th July, 2016</p>
									<a href="event-details.html"><h4>Schools Educational outreach</h4></a>
									<p>
										For most of us, the idea of astronomy is something we directly connect to “stargazing”, telescopes and seeing magnificent displays in the heavens.
									</p>
								</div>
						...
						<div class="col-lg-6">
							<div class="single-carusel row align-items-center">
								...
								<div class="detials col-12 col-md-6">
									...
									<a href="#"><h4>Youth Enterprise Development</h4></a>
									<p>
										For most of us, the idea of astronomy is something we directly connect to “stargazing”, telescopes and seeing magnificent displays in the heavens.
									</p>
								</div>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-4 cta-right">
							<a class="primary-btn wh" href="donate.php">Support Now</a>
						</div>
					</div>
				</div>	
			</section>
