	...
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Explore Africa Foundation | Contact</title>
		...
		<body>	
		  <header id="header" id="home">
	  			...
	  			<div class="container">
			  		<div class="row">
			  			...
			  			<div class="col-lg-6 col-sm-6 col-4 header-top-right no-padding">
			  				...
			  				<a href="mailto:support@colorlib.com"><span class="lnr lnr-envelope"></span> <span class="text">join@exploreafricafoundation.org</span></a>			
			  			</div>
			  		</div>			  					
	  			</div>
			</div>
		    	...
		    	<div class="row align-items-center justify-content-between d-flex">
			      ...
			      <nav id="nav-menu-container">
			        <ul class="nav-menu">
			          ...
			          <li class="menu-has-children"><a href="programme.php">Programmes</a>
			          	<ul id="mega-menu" class="mega-menu">
			          	  <div class="menu-img"><img src="img/m1.png" alt=""></div>
			          	  <div class="menu1"><span>Ongoing Campaign</span>
				              <li><a href="programme-details.php">Youth Konnect for Peace Network</a></li>
				              <li><a href="programme-details.php">Young leaders mentoring programme</a></li>
				              <li><a href="programme-details.php">Social innovators forum</a></li>
				              <li><a href="programme-details.php">Renovation and upgrade of community <br>schools libraries and laboratories</a></li>
			              </div>
			              
			              <div class="menu2">Popular Programmes
				              <li><a href="programme-details.php">Educational support and scholarship programme</a></li>
				              <li><a href="programme-details.php">Summer ICT and Personal development bootcamp</a></li>
				              <li><a href="programme-details.php">Schools Educational outreach</a></li>
				              <li><a href="programme-details.php">Youth Enterprise Development</a></li>
				              <li><a href="programme-details.php">Young Leaders club</a></li>
				              <li><a href="programme-details.php">Human capacity development</a></li>
				              <li><a href="programme-details.php">Skills acquisition programme</a></li>
				              <li><a href="programme-details.php">Capital creation scheme</a></li>
				              <li><a href="programme-details.php">Sector revamp and positioning</a></li>
			              </div>	
			            </ul>
			          </li>
			...
			<section class="contact-page-area section-gap">
				<div class="container">
					<div class="row">
						<div style="width: 100%; height: 445px; margin-bottom: 30px; ">
							<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3975.680465776214!2d7.036812014169148!3d4.824820396496373!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1069cdb01fd434fb%3A0x51a1c23f63f24c3d!2sTrans-Amadi+Industrial+Layout+Rd%2C+Port+Harcourt!5e0!3m2!1sen!2sng!4v1539183704598" width="100%" height="445" frameborder="0" style="border:0" allowfullscreen></iframe>
						</div>
						<div class="col-lg-4 d-flex flex-column address-wrap">
							<div class="single-contact-address d-flex flex-row">
								...
								<div class="contact-details">
									<h5>Trans-Amadi Industrial Layout Rd Port Harcourt</h5>
									<p>
										Visit us Anytime!
									</p>
								</div>
							...
							<div class="single-contact-address d-flex flex-row">
								...
								<div class="contact-details">
									<h5>support@exploreafricafoundation.com</h5>
